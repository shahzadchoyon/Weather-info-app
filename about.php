  ...
  <body style="background:#34acdf;">
    ...
    <div class="container">
      <div class="header clearfix" >
        <nav style=" margin-top:20px;  padding:5px;">
          <ul class="nav nav-pills pull-right">
            ...
            <li role="presentation" class="active" style="color:black;"><a href="">About</a></li>
      ...
      <div class="jumbotron">
        ...
        <p>This is a web application which is developed by using Weather API (json format). The link of the website is https://openweathermap.org/api.</p>
        <p>To make the API fully functional Also used Bootstrap, php, html, css.<br><br>The application is fully responsive.</p>
      </div>
